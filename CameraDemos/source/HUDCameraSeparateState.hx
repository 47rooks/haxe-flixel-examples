...
/**
 * A demo of creating a HUD camera place below the game's main camera.
 * This is a split-screen setup.
 */
class HUDCameraSeparateState extends FlxState
{
	...
	override public function create()
	{
		...
		// Create HUD camera
		// Set it to occupy the bottom 50 pixels of the screen. It is
		// full game width.
		var hudWidth = FlxG.width;
		var hudHeight = 50;
